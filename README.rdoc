...
Once you have a valid API key (user either your {account password}[https://mandrillapp.com/settings] or see the section below about OAuth) you can easily interact with the {Mandrill API}[http://mandrillapp.com/api/docs/index.html] by passing in arguments as a hash:
